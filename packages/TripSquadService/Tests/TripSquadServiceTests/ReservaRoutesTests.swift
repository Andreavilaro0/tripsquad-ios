...
struct ReservaRoutesTests {
    ...
    func crearActividad(_ client: some TestClientProtocol, tripId: String, creador: String) async throws -> String {
        ...
        try await client.execute(
            ...
            headers: [.authorization: try await bearer(creador), HTTPField.Name("idempotency-key")!: "k-auto-24", HTTPField.Name("idempotency-first-sent")!: isoReciente()], body: crearItemJSON()
